...
- Keep widget self-contained and embeddable
- Follow existing API patterns in `api/`
...
3. Read `tasks/todo.md` for outstanding work (if it exists)
4. Present a brief "here's where we are" summary and ask what to focus on
